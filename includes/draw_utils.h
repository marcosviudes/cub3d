...
/*   Updated: 2020/12/21 15:15:48 by mviudes          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_square(void *mlx, void *win, int posx,
					int posy, int size, int color);
void	draw_player(t_mlx *mlx, t_player *player);
void	draw_line(t_mlx *mlx, void *win, int x1,
